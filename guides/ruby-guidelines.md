...
Avoid N+1 problems when access to relationship records referencing it with `ìncludes`:
...
In order to avoid unexpected and hidden behaviour for a model avoid using default_scope and use named scopes and implicit calls.
