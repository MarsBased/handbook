...
Finally, if the candidate succeeds in the technical interview, we schedule another video call to perform a technical test. This is not a coding exercise, but rather a discussion where we ask the software engineer how they would architect a solution to a given problem. It usually takes an hour.
